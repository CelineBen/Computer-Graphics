...
public class Scene {
    ...
    private DoubleParameter sceneDistanceFromScrene = new DoubleParameter("scene distance", -0.01, -2, 1);    
    ...
    public void display( GLAutoDrawable drawable ) {
        ...
        gl.glTranslated( 0,0, sceneDistanceFromScrene.getValue());
    ...
    public JPanel getControls() {
        ...
        vfp.add ( sceneDistanceFromScrene.getSliderControls(false) );
